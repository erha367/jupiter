...
// Get 获取
func (obj *_EeoUserSharesMgr) Get() (result EeoUserShares, err error) {
...
// Gets 获取批量结果
func (obj *_EeoUserSharesMgr) Gets() (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetByOption(opts ...Option) (result EeoUserShares, err error) {
	options := options{
...
func (obj *_EeoUserSharesMgr) GetByOptions(opts ...Option) (results []*EeoUserShares, err error) {
	options := options{
		query: make(map[string]interface{}, len(opts)),
	}
	for _, o := range opts {
...
func (obj *_EeoUserSharesMgr) GetFromShareID(shareID int64) (result EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromShareID(shareIDs []int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromUserID(userID int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromUserID(userIDs []int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromUserResourceType(userResourceType bool) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromUserResourceType(userResourceTypes []bool) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromUserResourceID(userResourceID int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromUserResourceID(userResourceIDs []int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromUserResourceName(userResourceName string) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromUserResourceName(userResourceNames []string) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromUserResourceExtension(userResourceExtension string) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromUserResourceExtension(userResourceExtensions []string) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromUserResourceSize(userResourceSize int) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromUserResourceSize(userResourceSizes []int) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromSaveNum(saveNum int) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromSaveNum(saveNums []int) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromIsdel(isdel bool) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromIsdel(isdels []bool) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromAddtime(addtime int) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromAddtime(addtimes []int) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromFileID(fileID int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromFileID(fileIDs []int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromOldID(oldID int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromOldID(oldIDs []int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromType(_type int8) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromType(_types []int8) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromCourseID(courseID int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromCourseID(courseIDs []int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetFromSid(sid int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) GetBatchFromSid(sids []int64) (results []*EeoUserShares, err error) {
...
func (obj *_EeoUserSharesMgr) FetchByPrimaryKey(shareID int64) (result EeoUserShares, err error) {
	err = obj.DB.Table(obj.GetTableName()).Where("share_id = ?", shareID).Find(&result).Error
