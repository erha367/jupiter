...
// Get 获取
func (obj *_EeoUserFilesMgr) Get() (result EeoUserFiles, err error) {
...
// Gets 获取批量结果
func (obj *_EeoUserFilesMgr) Gets() (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetByOption(opts ...Option) (result EeoUserFiles, err error) {
	options := options{
...
func (obj *_EeoUserFilesMgr) GetByOptions(opts ...Option) (results []*EeoUserFiles, err error) {
	options := options{
		query: make(map[string]interface{}, len(opts)),
	}
	for _, o := range opts {
...
func (obj *_EeoUserFilesMgr)  GetFromID(id int64) (result EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromID(ids []int64) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr)  GetFromUserID(userID int64) (result EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromUserID(userIDs []int64) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromFileID(fileID int64) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromFileID(fileIDs []int64) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr)  GetFromFolderID(folderID int64) (result EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromFolderID(folderIDs []int64) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromFileName(fileName string) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromFileName(fileNames []string) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromFileSize(fileSize int) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromFileSize(fileSizes []int) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromFileExtension(fileExtension string) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromFileExtension(fileExtensions []string) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromTransitionState(transitionState bool) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromTransitionState(transitionStates []bool) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromFileNamePy(fileNamePy string) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromFileNamePy(fileNamePys []string) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromIsdel(isdel bool) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromIsdel(isdels []bool) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromExp1(exp1 bool) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromExp1(exp1s []bool) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromAddtime(addtime int) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromAddtime(addtimes []int) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromUptime(uptime int) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromUptime(uptimes []int) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromAllowOperate(allowOperate uint8) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromAllowOperate(allowOperates []uint8) (results []*EeoUserFiles, err error) {
...
// 
func (obj *_EeoUserFilesMgr) GetFromExamTopicSum(examTopicSum int) (results []*EeoUserFiles, err error) {
...
//
func (obj *_EeoUserFilesMgr) GetBatchFromExamTopicSum(examTopicSums []int) (results []*EeoUserFiles, err error) {
...
// 
func (obj *_EeoUserFilesMgr) GetFromFullMarks(fullMarks int) (results []*EeoUserFiles, err error) {
...
//
func (obj *_EeoUserFilesMgr) GetBatchFromFullMarks(fullMarkss []int) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromVersion(version int8) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromVersion(versions []int8) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromType(_type int8) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromType(_types []int8) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromOldID(oldID int64) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromOldID(oldIDs []int64) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetFromEdocAuth(edocAuth int8) (results []*EeoUserFiles, err error) {
...
func (obj *_EeoUserFilesMgr) GetBatchFromEdocAuth(edocAuths []int8) (results []*EeoUserFiles, err error) {
 ...
 func (obj *_EeoUserFilesMgr) FetchByPrimaryKey(id int64 ) (result EeoUserFiles, err error) {
	err = obj.DB.Table(obj.GetTableName()).Where("id = ?", id).Find(&result).Error
 ...
 // FetchIndexByEeoUserFiles#userID  获取多个内容
 func (obj *_EeoUserFilesMgr) FetchIndexByEeoUserFiles#userID(userID int64 ) (results []*EeoUserFiles, err error) {
 ...
 func (obj *_EeoUserFilesMgr) FetchIndexByFolderID(folderID int64 ) (results []*EeoUserFiles, err error) {
