...
// Get 获取
func (obj *_EeoFilesMgr) Get() (result EeoFiles, err error) {
...
// Gets 获取批量结果
func (obj *_EeoFilesMgr) Gets() (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetByOption(opts ...Option) (result EeoFiles, err error) {
	options := options{
...
func (obj *_EeoFilesMgr) GetByOptions(opts ...Option) (results []*EeoFiles, err error) {
	options := options{
		query: make(map[string]interface{}, len(opts)),
	}
	for _, o := range opts {
...
func (obj *_EeoFilesMgr)  GetFromFileID(fileID int64) (result EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromFileID(fileIDs []int64) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromFileSavePath(fileSavePath string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromFileSavePath(fileSavePaths []string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromFileSaveName(fileSaveName string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromFileSaveName(fileSaveNames []string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromFileExtension(fileExtension string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromFileExtension(fileExtensions []string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr)  GetFromFileSize(fileSize int) (result EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromFileSize(fileSizes []int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromTransitionFiles(transitionFiles string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromTransitionFiles(transitionFiless []string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromTransitionData(transitionData string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromTransitionData(transitionDatas []string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromTransitionState(transitionState bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromTransitionState(transitionStates []bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromModerationState(moderationState int8) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromModerationState(moderationStates []int8) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr)  GetFromUploadUserid(uploadUserid int64) (result EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromUploadUserid(uploadUserids []int64) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromFileType(fileType bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromFileType(fileTypes []bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromSystemDel(systemDel bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromSystemDel(systemDels []bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromSystemLock(systemLock bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromSystemLock(systemLocks []bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromSaveNum(saveNum int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromSaveNum(saveNums []int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromDownNum(downNum int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromDownNum(downNums []int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromExp1(exp1 bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromExp1(exp1s []bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromMigrateStatus(migrateStatus bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromMigrateStatus(migrateStatuss []bool) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromMigrateTime(migrateTime int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromMigrateTime(migrateTimes []int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr)  GetFromAddtime(addtime int) (result EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromAddtime(addtimes []int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromUptime(uptime int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromUptime(uptimes []int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromTransitionType(transitionType string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromTransitionType(transitionTypes []string) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromTransitionStartTime(transitionStartTime int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromTransitionStartTime(transitionStartTimes []int) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetFromTransitionLongs(transitionLongs int64) (results []*EeoFiles, err error) {
...
func (obj *_EeoFilesMgr) GetBatchFromTransitionLongs(transitionLongss []int64) (results []*EeoFiles, err error) {
 ...
 func (obj *_EeoFilesMgr) FetchByPrimaryKey(fileID int64 ) (result EeoFiles, err error) {
	err = obj.DB.Table(obj.GetTableName()).Where("file_id = ?", fileID).Find(&result).Error
 ...
 // FetchIndexByEeoFiles#fileExtension#transitionState  获取多个内容
 func (obj *_EeoFilesMgr) FetchIndexByEeoFiles#fileExtension#transitionState(fileExtension string ,transitionState bool ) (results []*EeoFiles, err error) {
	err = obj.DB.Table(obj.GetTableName()).Where("file_extension = ? AND transition_state = ?", fileExtension , transitionState).Find(&results).Error
	
	return
}
 
 // FetchIndexByIEfFilesize  获取多个内容
 func (obj *_EeoFilesMgr) FetchIndexByIEfFilesize(fileSize int ) (results []*EeoFiles, err error) {
 ...
 func (obj *_EeoFilesMgr) FetchIndexByEeoFilesUploadUserid(uploadUserid int64 ) (results []*EeoFiles, err error) {
 ...
 func (obj *_EeoFilesMgr) FetchIndexByIEfAddt(addtime int ) (results []*EeoFiles, err error) {
