...
// Get 获取
func (obj *_EeoUserFoldersMgr) Get() (result entity.EeoUserFolders, err error) {
...
// Gets 获取批量结果
func (obj *_EeoUserFoldersMgr) Gets() (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetByOption(opts ...Option) (result entity.EeoUserFolders, err error) {
	options := options{
...
func (obj *_EeoUserFoldersMgr) GetByOptions(opts ...Option) (results []*entity.EeoUserFolders, err error) {
	options := options{
		query: make(map[string]interface{}, len(opts)),
	}
	for _, o := range opts {
...
func (obj *_EeoUserFoldersMgr) GetFromFolderID(folderID int64) (result entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromFolderID(folderIDs []int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromUserID(userID int64) (result entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromUserID(userIDs []int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromFolderName(folderName string) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromFolderName(folderNames []string) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromFolderNamePy(folderNamePy string) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromFolderNamePy(folderNamePys []string) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromFolderNode(folderNode bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromFolderNode(folderNodes []bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromParentID(parentID int64) (result entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromParentID(parentIDs []int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromFolderPath(folderPath string) (result entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromFolderPath(folderPaths []string) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromSystemLock(systemLock bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromSystemLock(systemLocks []bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromExp1(exp1 bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromExp1(exp1s []bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromOperateLevel(operateLevel bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromOperateLevel(operateLevels []bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromIsdel(isdel bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromIsdel(isdels []bool) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromAddtime(addtime int) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromAddtime(addtimes []int) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromUptime(uptime int) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromUptime(uptimes []int) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromFromID(fromID int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromFromID(fromIDs []int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromFromParent(fromParent int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromFromParent(fromParents []int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromType(_type int8) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromType(_types []int8) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromOldID(oldID int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromOldID(oldIDs []int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetFromBatchOperateTime(batchOperateTime int64) (result entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) GetBatchFromBatchOperateTime(batchOperateTimes []int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) FetchByPrimaryKey(folderID int64) (result entity.EeoUserFolders, err error) {
	err = obj.DB.Table(obj.GetTableName()).Where("folder_id = ?", folderID).Find(&result).Error
...
func (obj *_EeoUserFoldersMgr) FetchIndexByUserID(userID int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) FetchIndexByParenterID(parentID int64) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) FetchIndexByFolderPath(folderPath string) (results []*entity.EeoUserFolders, err error) {
...
func (obj *_EeoUserFoldersMgr) FetchIndexByIBatchOperateTime(batchOperateTime int64) (results []*entity.EeoUserFolders, err error) {
