...
// Get 获取
func (obj *_EeoCourseFilesMgr) Get() (result entity.EeoCourseFiles, err error) {
...
// Gets 获取批量结果
func (obj *_EeoCourseFilesMgr) Gets() (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetByOption(opts ...Option) (result entity.EeoCourseFiles, err error) {
	options := options{
...
func (obj *_EeoCourseFilesMgr) GetByOptions(opts ...Option) (results []*entity.EeoCourseFiles, err error) {
	options := options{
		query: make(map[string]interface{}, len(opts)),
	}
	for _, o := range opts {
...
func (obj *_EeoCourseFilesMgr) GetFromID(id int64) (result entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromID(ids []int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromSid(sid int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromSid(sids []int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromCourseID(courseID int64) (result entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromCourseID(courseIDs []int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromUserID(userID int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromUserID(userIDs []int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromFileID(fileID int64) (result entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromFileID(fileIDs []int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromFolderID(folderID int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromFolderID(folderIDs []int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromFileName(fileName string) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromFileName(fileNames []string) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromUserName(userName string) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromUserName(userNames []string) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromFileSize(fileSize int) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromFileSize(fileSizes []int) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromFileExtension(fileExtension string) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromFileExtension(fileExtensions []string) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromFileNamePy(fileNamePy string) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromFileNamePy(fileNamePys []string) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromIsdel(isdel bool) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromIsdel(isdels []bool) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromExp1(exp1 int8) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromExp1(exp1s []int8) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromAddtime(addtime int) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromAddtime(addtimes []int) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromUptime(uptime int) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromUptime(uptimes []int) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetFromType(_type int8) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) GetBatchFromType(_types []int8) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) FetchByPrimaryKey(id int64) (result entity.EeoCourseFiles, err error) {
	err = obj.DB.Table(obj.GetTableName()).Where("id = ?", id).Find(&result).Error
...
func (obj *_EeoCourseFilesMgr) FetchIndexByICourseID(courseID int64) (results []*entity.EeoCourseFiles, err error) {
...
func (obj *_EeoCourseFilesMgr) FetchIndexByIFileID(fileID int64) (results []*entity.EeoCourseFiles, err error) {
