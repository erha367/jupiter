...
// Get 获取
func (obj *_EeoCourseFoldersMgr) Get() (result entity.EeoCourseFolders, err error) {
...
// Gets 获取批量结果
func (obj *_EeoCourseFoldersMgr) Gets() (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetByOption(opts ...Option) (result entity.EeoCourseFolders, err error) {
	options := options{
...
func (obj *_EeoCourseFoldersMgr) GetByOptions(opts ...Option) (results []*entity.EeoCourseFolders, err error) {
	options := options{
		query: make(map[string]interface{}, len(opts)),
	}
	for _, o := range opts {
...
func (obj *_EeoCourseFoldersMgr) GetFromFolderID(folderID int64) (result entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromFolderID(folderIDs []int64) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromSid(sid int64) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromSid(sids []int64) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromCourseID(courseID int64) (result entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromCourseID(courseIDs []int64) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromFolderName(folderName string) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromFolderName(folderNames []string) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromFolderNode(folderNode int8) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromFolderNode(folderNodes []int8) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromParentID(parentID int64) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromParentID(parentIDs []int64) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromFolderPath(folderPath string) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromFolderPath(folderPaths []string) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromExp1(exp1 bool) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromExp1(exp1s []bool) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromOperateLevel(operateLevel bool) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromOperateLevel(operateLevels []bool) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromIsdel(isdel bool) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromIsdel(isdels []bool) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromAddtime(addtime int) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromAddtime(addtimes []int) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromUptime(uptime int) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromUptime(uptimes []int) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromUserName(userName string) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromUserName(userNames []string) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetFromUserID(userID int64) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) GetBatchFromUserID(userIDs []int64) (results []*entity.EeoCourseFolders, err error) {
...
func (obj *_EeoCourseFoldersMgr) FetchByPrimaryKey(folderID int64) (result entity.EeoCourseFolders, err error) {
	err = obj.DB.Table(obj.GetTableName()).Where("folder_id = ?", folderID).Find(&result).Error
...
func (obj *_EeoCourseFoldersMgr) FetchIndexByICourseID(courseID int64) (results []*entity.EeoCourseFolders, err error) {
