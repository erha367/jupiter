...
// Get 获取
func (obj *_EeoFileMiddleTransateMgr) Get() (result entity.EeoFileMiddleTransate, err error) {
...
// Gets 获取批量结果
func (obj *_EeoFileMiddleTransateMgr) Gets() (results []*entity.EeoFileMiddleTransate, err error) {
...
func (obj *_EeoFileMiddleTransateMgr) GetByOption(opts ...Option) (result entity.EeoFileMiddleTransate, err error) {
	options := options{
...
func (obj *_EeoFileMiddleTransateMgr) GetByOptions(opts ...Option) (results []*entity.EeoFileMiddleTransate, err error) {
	options := options{
		query: make(map[string]interface{}, len(opts)),
	}
	for _, o := range opts {
...
func (obj *_EeoFileMiddleTransateMgr) GetFromID(id int) (result entity.EeoFileMiddleTransate, err error) {
...
func (obj *_EeoFileMiddleTransateMgr) GetBatchFromID(ids []int) (results []*entity.EeoFileMiddleTransate, err error) {
...
func (obj *_EeoFileMiddleTransateMgr) GetFromUId(uid int64) (results []*entity.EeoFileMiddleTransate, err error) {
...
func (obj *_EeoFileMiddleTransateMgr) GetBatchFromUId(uids []int64) (results []*entity.EeoFileMiddleTransate, err error) {
...
func (obj *_EeoFileMiddleTransateMgr) GetFromType(_type string) (results []*entity.EeoFileMiddleTransate, err error) {
...
func (obj *_EeoFileMiddleTransateMgr) GetBatchFromType(_types []string) (results []*entity.EeoFileMiddleTransate, err error) {
...
func (obj *_EeoFileMiddleTransateMgr) GetFromCount(count int) (results []*entity.EeoFileMiddleTransate, err error) {
...
func (obj *_EeoFileMiddleTransateMgr) GetBatchFromCount(counts []int) (results []*entity.EeoFileMiddleTransate, err error) {
...
func (obj *_EeoFileMiddleTransateMgr) FetchByPrimaryKey(id int) (result entity.EeoFileMiddleTransate, err error) {
	err = obj.DB.Table(obj.GetTableName()).Where("id = ?", id).Find(&result).Error
